...
class ViewController: UIViewController {
    ...
    @IBAction func WeatherButton(_ sender:UIButton) {UIApplication.shared.open(URL(string:"https://www.bbc.co.uk/weather/2657308")!as URL, options :[:], completionHandler: nil)
    }
    
    
    
    @IBAction func whatsapp(_ sender: Any) {UIApplication.shared.open(URL(string:"maps://?q=angmering")!as URL, options :[:], completionHandler: nil)
    }
 ...
 //       nextLW.text = "-"
   ...
   //         nextHW.isHidden = false
    ...
    func updateLocation() {
        ...
        self.info.text = "Here is the real time wind and temperature data from \(place)"
        refresh(self)
    }
